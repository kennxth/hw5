...
//Done: Update these using statements to include your project name
using ChenKennethHW5.DAL;
using ChenKennethHW5.Models;

//Done: Upddate this namespace to match your project name
namespace ChenKennethHW5.Utilities
{
    public static class AddUser
    {
        public async static Task<IdentityResult> AddUserWithRoleAsync(AddUserModel aum, UserManager<AppUser> userManager, AppDbContext _context)
        {
            ...
            else //user is already in database, update the fields
            {
                ...
                //Done: Update any fields that you added to appuser
